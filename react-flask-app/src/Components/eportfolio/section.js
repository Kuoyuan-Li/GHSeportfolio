...
class Section extends React.Component {
    ...
    async componentDidMount () {
        await fetch ('http://127.0.0.1:5000/getModules',{
            mode: 'cors',
            method : 'POST',
            headers :{
    ...
    addModuleHandler = () => {   
		...
		fetch ('http://127.0.0.1:5000/addModule',{
            mode: 'cors',
            method : 'POST',
            headers :{
                'Accept': 'application/json',
    ...
    sectionTitleSaveHandler = () =>{
            fetch ('http://127.0.0.1:5000/saveSection',{
            mode: 'cors',
            method : 'POST',            
            headers :{
                'Accept': 'application/json',
    ...
    deleteModule (id){
        ...
        fetch ('http://127.0.0.1:5000/deleteModule',{
                mode: 'cors',
                method : 'POST',
                headers :{
                    'Accept': 'application/json',
